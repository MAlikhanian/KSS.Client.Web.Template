    ...
    onSuccess: (updatedUser) => {
      ...
      toast.custom(() => (
        <Alert variant="mono" icon="success">
          ...
          <AlertTitle>{t('account.profile.messages.accountUpdated')}</AlertTitle>
        </Alert>
      ));
          ...
          >
              ...
              render={({ field }) => (
                <FormItem>
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <FormLabel>{t('account.profile.fields.profileAvatar')}</FormLabel>
                      <FormControl className="my-1.5">
                        <div className="flex flex-col space-y-1">
                          <div className="flex space-x-2">
                            ...
                            >
                              {t('account.profile.fields.attachImage')}
                            </Button>
                            ...
                            !avatarAttachedPreview ? (
                              ...
                              >
                                {t('account.profile.fields.remove')}
                              </Button>
                            ) : null}
                          </div>
                          <input
                      ...
                      <FormDescription>
                        {t('account.profile.avatarDescription')}
                      </FormDescription>
                      <FormMessage />
                    </div>
                  </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder={t('account.profile.fields.namePlaceholder')} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex justify-end gap-2.5">
              <Button type="button" variant="outline" onClick={handleFormReset}>
                {t('account.profile.buttons.reset')}
              </Button>
              <Button
                type="submit"
              ...
              >
                ...
                {t('account.profile.buttons.saveProfile')}
              </Button>
            </div>
          </form>
        </Form>

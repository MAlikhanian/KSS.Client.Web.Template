...
export default function UserLayout({
  ...
  const navRoutes = useMemo<NavRoutes>(
    () => ({
      ...
      logs: {
        title: t('users.layout.activityLogs'),
        icon: Activity,
  ...
  return (
    <UserProvider user={user} isLoading={isLoading}>
      <Container>
        <Toolbar>
          <ToolbarHeading>
            <ToolbarTitle>{t('users.layout.title')}</ToolbarTitle>
            <Breadcrumb>
              <BreadcrumbList>
                <BreadcrumbItem>
                  <BreadcrumbLink href="/">{t('users.layout.home')}</BreadcrumbLink>
                </BreadcrumbItem>
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbPage>{t('users.layout.userManagement')}</BreadcrumbPage>
                </BreadcrumbItem>
                <BreadcrumbSeparator />
                <BreadcrumbItem>
                  <BreadcrumbLink href="/user-management/users">{t('users.layout.users')}</BreadcrumbLink>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </ToolbarHeading>
          <ToolbarActions>
            <Button asChild variant="outline">
              <Link href="/user-management/users">
                <MoveLeft /> {t('users.layout.backToUsers')}
              </Link>
            </Button>
          </ToolbarActions>
        </Toolbar>

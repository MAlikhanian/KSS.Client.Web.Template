...
const RoleDeleteDialog = ({
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      const message = t('roles.dialogs.delete.messages.roleDeleted');
  ...
  return (
    <Dialog open={open} onOpenChange={closeDialog}>
      <DialogContent showCloseButton={false}>
        <DialogHeader>
          <DialogTitle>{t('roles.dialogs.delete.title')}</DialogTitle>
        </DialogHeader>
        <DialogDescription>
          {t('roles.dialogs.delete.description', { name: role.name })}
        </DialogDescription>
        <DialogFooter>
          ...
          >
            ...
            {t('roles.dialogs.delete.buttons.delete')}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>

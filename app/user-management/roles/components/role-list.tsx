    ...
    () => [
      {
        ...
        id: 'name',
        header: ({ column }) => (
          <DataGridColumnHeader title={t('roles.table.columns.role')} column={column} visibility />
        ),
        cell: ({ row, getValue }) => {
            ...
            <div className="flex items-center flex-wrap gap-2">
              ...
              {isProtected && (
                <Badge variant="outline">
                  ...
                  {t('roles.table.badges.system')}
                </Badge>
              )}
              {isDefault && (
                <Badge variant="outline">
                  <UserRound className="text-success" />
                  {t('roles.table.badges.default')}
                </Badge>
              )}
            </div>
          );
        ...
        enableHiding: false,
        meta: {
          headerTitle: t('roles.table.columns.role'),
      ...
      },
      {
        ...
        id: 'slug',
        header: ({ column }) => (
          <DataGridColumnHeader title={t('roles.table.columns.slug')} column={column} visibility />
        ),
        size: 125,
        cell: (info) => {
      ...
      },
      {
            ...
            <div className="flex items-center gap-1 flex-wrap">
              ...
              {extraPermissionsCount > 0 && (
                <span className="text-muted-foreground text-xs ms-1">
                  {t('roles.table.badges.more', { count: extraPermissionsCount })}
                </span>
              )}
            </div>
          );
        ...
        enableHiding: true,
        meta: {
          headerTitle: t('roles.table.columns.permissions'),
          skeleton: <Skeleton className="w-44 h-7" />,
        },
      },
      {
        id: 'actions',
        header: t('roles.table.columns.actions'),
        cell: ({ row }) => (
          <DropdownMenu>
            ...
            <DropdownMenuContent side="bottom" align="start">
              ...
              >
                {t('roles.table.dropdown.editRole')}
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              >
                {t('roles.table.dropdown.setAsDefault')}
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
                variant="destructive"
              ...
              >
                {t('roles.table.dropdown.deleteRole')}
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        ),
      ...
      <CardHeader className="py-5">
        <div className="flex items-center gap-2.5">
          <div className="relative">
            ...
            <Input
              placeholder={t('roles.table.search.placeholder')}
              value={inputValue}

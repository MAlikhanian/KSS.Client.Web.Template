      ...
      toast.custom(
        () => (
          <Alert variant="mono" icon="success">
            ...
            <AlertTitle>{t('settings.general.messages.settingsUpdated')}</AlertTitle>
          </Alert>
        ),
        {
          position: 'top-center',
      ...
      toast.custom(
        (toastId) => (
          ...
          >
            ...
            <AlertTitle>
              {t('settings.general.messages.formHasErrors')}
            </AlertTitle>
          </Alert>
        ),
        {
        ...
        <Form {...form}>
          ...
          >
              ...
              render={({ field }) => (
                <FormItem>
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      <FormLabel>{t('settings.general.fields.companyLogo')}</FormLabel>
                      <FormControl className="my-1.5">
                        <div className="flex flex-col space-y-2">
                          <div className="flex space-x-2">
                            ...
                            >
                              {t('settings.general.fields.attachImage')}
                            </Button>
                            ...
                            !logoAttachedPreview ? (
                              ...
                              >
                                {t('settings.general.fields.remove')}
                              </Button>
                            ) : null}
                          </div>
                          <input
                      ...
                      <FormDescription>
                        {t('settings.general.fields.logoDescription')}
                      </FormDescription>
                      <FormMessage />
                    </div>
                  </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.fields.shopName')}</FormLabel>
                  <FormControl>
                    <Input placeholder={t('settings.general.fields.shopNamePlaceholder')} {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.fields.shopStatus')}</FormLabel>
                  <FormControl>
                    <div className="flex items-center space-x-2 rounded-lg bg-accent/60 p-4">
                      ...
                      <Label htmlFor="active">
                        {t('settings.general.fields.shopStatusDescription')}
                      </Label>
                    </div>
                  </FormControl>
                  <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.fields.address')}</FormLabel>
                  <FormControl>
                    <Textarea
                      rows={3}
                      id="address"
                      ...
                      placeholder={t('settings.general.fields.addressPlaceholder')}
                    />
                  </FormControl>
                  <FormDescription>
                    {t('settings.general.fields.addressDescription')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue placeholder={t('settings.general.fields.languagePlaceholder')} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.fields.websiteURL')}</FormLabel>
                  <FormControl>
                    <Input
                      id="websiteURL"
                      type="url"
                      placeholder={t('settings.general.fields.websiteURLPlaceholder')}
                      value={field.value || ''}
                      onChange={field.onChange}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.fields.supportEmail')}</FormLabel>
                  <FormControl>
                    <Input
                      id="supportEmail"
                      type="email"
                      placeholder={t('settings.general.fields.supportEmailPlaceholder')}
                      value={field.value || ''}
                      onChange={field.onChange}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.fields.supportPhone')}</FormLabel>
                  <FormControl>
                    <Input
                      id="supportPhone"
                      type="tel"
                      placeholder={t('settings.general.fields.supportPhonePlaceholder')}
                      value={field.value || ''}
                      onChange={field.onChange}
                    />
                  </FormControl>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue placeholder={t('settings.general.fields.currencyPlaceholder')} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
                  ...
                  <FormDescription>
                    {t('settings.general.fields.currencyDescription')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('settings.general.fields.currencyFormat')}</FormLabel>
                  <FormControl>
                    <Select
                      onValueChange={field.onChange}
                      defaultValue={field.value}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder={t('settings.general.fields.currencyFormatPlaceholder')} />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
                  ...
                  <FormDescription>
                    {t('settings.general.fields.currencyFormatDescription')}
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex gap-2.5 justify-end">
              <Button type="button" variant="outline" onClick={handleFormReset}>
                {t('settings.general.buttons.reset')}
              </Button>
              <Button
                type="submit"
              ...
              >
                ...
                {t('settings.general.buttons.saveSettings')}
              </Button>
            </div>
          </form>
        </Form>

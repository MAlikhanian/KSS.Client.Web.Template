...
function ActionsCell({ row }: { row: Row<IData> }) {
  ...
  const handleCopyId = () => {
    ...
    const message = t('accountMembersTeamInfo.members.memberIdCopied', { id: row.original.id });
    toast.custom(
      (t) => (
        <Alert
          variant="mono"
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="bottom" align="end">
        <DropdownMenuItem onClick={() => {}}>{t('accountMembersTeamInfo.members.actions.edit')}</DropdownMenuItem>
        <DropdownMenuItem onClick={handleCopyId}>{t('accountMembersTeamInfo.members.actions.copyId')}</DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem variant="destructive" onClick={() => {}}>
          {t('accountMembersTeamInfo.members.actions.delete')}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamInfo.members.columns.member')} column={column} />
        ),
        cell: ({ row }) => (
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-sm text-secondary-foreground font-normal">
                {row.original.member.tasks} {t('accountMembersTeamInfo.members.tasks')}
              </span>
            </div>
          </div>
        ),
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamInfo.members.columns.location')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamInfo.members.columns.status')} column={column} />
        ),
        cell: ({ row }) => (
          <Badge
            size="lg"
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamInfo.members.columns.recentActivity')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      <CardToolbar>
        <div className="flex flex-wrap items-center gap-2.5">
          <Label htmlFor="auto-update" className="text-sm">
            {t('accountMembersTeamInfo.members.toolbar.activeUsers')}
          </Label>
        ...
        <DataGridColumnVisibility
          ...
          trigger={
            <Button variant="outline">
              <Settings2 />
              {t('accountMembersTeamInfo.members.toolbar.columns')}
            </Button>
          }
        />
      </CardToolbar>
          ...
          <CardHeading>
            <div className="flex items-center gap-2.5">
              <div className="relative">
                ...
                <Input
                  placeholder={t('accountMembersTeamInfo.members.searchPlaceholder')}
                  value={searchQuery}
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline">
                    <Filter />
                    {t('accountMembersTeamInfo.members.status')}
                ...
                <PopoverContent className="w-40 p-3" align="start">
                  <div className="space-y-3">
                    <div className="text-xs font-medium text-muted-foreground">
                      {t('accountMembersTeamInfo.members.filters')}
                    </div>
                    <div className="space-y-3">

...
const ConnectedProfiles = () => {
        ...
        <div className="flex items-center grow gap-2.5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-xs text-secondary-foreground">
              {item.user.tasks} {t('accountMembersTeamInfo.connectedProfiles.tasks')}
            </span>
          </div>
        </div>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>{t('accountMembersTeamInfo.connectedProfiles.title', { count: 2 })}</CardTitle>
      </CardHeader>
      ...
      <CardFooter className="justify-center">
        <Button variant="outline">
          <Link href="#">{t('accountMembersTeamInfo.connectedProfiles.connectProfile')}</Link>
        </Button>
      </CardFooter>
    </Card>
  );

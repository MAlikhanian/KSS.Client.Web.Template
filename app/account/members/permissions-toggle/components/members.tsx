...
function ActionsCell({ row }: { row: Row<IMembersData> }) {
  ...
  const handleCopyId = () => {
    ...
    const message = t('accountMembersPermissionsToggle.members.memberIdCopied', { id: row.original.id });
    toast.custom(
      (t) => (
        <Alert
          variant="mono"
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="bottom" align="end">
        <DropdownMenuItem onClick={() => {}}>{t('accountMembersPermissionsToggle.members.actions.edit')}</DropdownMenuItem>
        <DropdownMenuItem onClick={handleCopyId}>{t('accountMembersPermissionsToggle.members.actions.copyId')}</DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem variant="destructive" onClick={() => {}}>
          {t('accountMembersPermissionsToggle.members.actions.delete')}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
  ...
  const columns = useMemo<ColumnDef<IMembersData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersPermissionsToggle.members.columns.member')} column={column} />
        ),
        cell: (info) => (
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-sm text-secondary-foreground font-normal">
                {info.row.original.member.tasks} {t('accountMembersPermissionsToggle.members.tasks')}
              </span>
            </div>
          </div>
        ),
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersPermissionsToggle.members.columns.location')} column={column} />
        ),
        cell: (info) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersPermissionsToggle.members.columns.status')} column={column} />
        ),
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersPermissionsToggle.members.columns.recentActivity')} column={column} />
        ),
        cell: (info) => info.getValue(),
        enableSorting: true,
        size: 225,
      ...
      <CardToolbar>
        <div className="flex flex-wrap items-center gap-2.5">
          <Label htmlFor="auto-update" className="text-sm">
            {t('accountMembersPermissionsToggle.members.toolbar.activeUsers')}
          </Label>
        ...
        <DataGridColumnVisibility
          ...
          trigger={
            <Button variant="outline">
              <Settings2 />
              {t('accountMembersPermissionsToggle.members.toolbar.columns')}
            </Button>
          }
        />
      </CardToolbar>
          ...
          <CardHeading>
            <div className="flex items-center gap-2.5">
              ...
              <div className="relative">
                ...
                <Input
                  placeholder={t('accountMembersPermissionsToggle.members.searchPlaceholder')}
                  value={searchQuery}

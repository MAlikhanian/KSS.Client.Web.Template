...
function ActionsCell({ row }: { row: Row<IData> }) {
  ...
  const handleCopyId = () => {
    ...
    const message = t('accountMembersTeamMembers.members.memberIdCopied', { id: row.original.id });
    toast.custom(
      (t) => (
        <Alert
          variant="mono"
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="bottom" align="end">
        <DropdownMenuItem onClick={() => {}}>{t('accountMembersTeamMembers.members.actions.edit')}</DropdownMenuItem>
        <DropdownMenuItem onClick={handleCopyId}>{t('accountMembersTeamMembers.members.actions.copyId')}</DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem variant="destructive" onClick={() => {}}>
          {t('accountMembersTeamMembers.members.actions.delete')}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamMembers.members.columns.member')} column={column} />
        ),
        cell: ({ row }) => (
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-sm text-secondary-foreground font-normal">
                {row.original.member.tasks} {t('accountMembersTeamMembers.members.tasks')}
              </span>
            </div>
          </div>
        ),
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamMembers.members.columns.roles')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamMembers.members.columns.location')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamMembers.members.columns.status')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountMembersTeamMembers.members.columns.recentActivity')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      <CardToolbar>
        <div className="flex flex-wrap items-center gap-2.5">
          <Label htmlFor="auto-update" className="text-sm">
            {t('accountMembersTeamMembers.members.toolbar.activeUsers')}
          </Label>
          <Switch size="sm" id="auto-update" defaultChecked />
          <Button>
            <UserRoundPlus />
            {t('accountMembersTeamMembers.members.toolbar.addNew')}
          </Button>
        </div>
        <DataGridColumnVisibility
          ...
          trigger={
            <Button variant="outline">
              <Settings2 />
              {t('accountMembersTeamMembers.members.toolbar.columns')}
            </Button>
          }
        />
      </CardToolbar>
          ...
          <CardHeading>
            <div className="flex items-center gap-2.5">
              <div className="relative">
                ...
                <Input
                  placeholder={t('accountMembersTeamMembers.members.searchPlaceholder')}
                  value={searchQuery}
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline">
                    <Filter />
                    {t('accountMembersTeamMembers.members.status')}
                ...
                <PopoverContent className="w-40 p-3" align="start">
                  <div className="space-y-3">
                    <div className="text-xs font-medium text-muted-foreground">
                      {t('accountMembersTeamMembers.members.filters')}
                    </div>
                    <div className="space-y-3">

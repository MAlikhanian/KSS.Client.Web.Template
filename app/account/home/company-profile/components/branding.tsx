    ...
    <>
      ...
      <Card className="min-w-full">
        <CardHeader className="gap-2">
          <CardTitle>{t('accountCompanyProfile.branding.title')}</CardTitle>
          <div className="flex items-center gap-2">
            <Label htmlFor="auto-update" className="text-sm">
              {t('accountCompanyProfile.branding.publish')}
            </Label>
        ...
        <CardContent className="lg:py-7.5 py-5">
          <div className="flex flex-wrap justify-between gap-5">
            <div className="flex flex-col">
              <div className="text-mono text-sm font-medium">{t('accountCompanyProfile.branding.companyLogo')}</div>
              <span className="text-secondary-foreground text-sm">
                {t('accountCompanyProfile.branding.emblematicCorporateIdentity')}
              </span>
            </div>
            <div className="flex flex-wrap sm:flex-nowrap gap-5 lg:gap-7.5 max-w-96 w-full">
              ...
              <div className="flex bg-center w-full p-5 lg:p-7 bg-no-repeat bg-[length:550px] border border-input rounded-xl border-dashed branding-bg">
                <div className="flex flex-col place-items-center place-content-center text-center rounded-xl w-full">
                  ...
                  >
                    {t('accountCompanyProfile.branding.clickOrDragDrop')}
                  </Link>
                  <span className="text-xs text-secondary-foreground text-nowrap">
                    {t('accountCompanyProfile.branding.fileFormats')}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap justify-between gap-5">
            <div className="flex flex-col">
              <div className="text-mono text-sm font-medium">{t('accountCompanyProfile.branding.brandColor')}</div>
              <span className="text-secondary-foreground text-sm">
                {t('accountCompanyProfile.branding.signaturePalette')}
              </span>
            </div>
          ...
          <div className="flex flex-wrap justify-between gap-5">
            <div className="flex flex-col">
              <div className="text-mono text-sm font-medium">{t('accountCompanyProfile.branding.brandingTitle')}</div>
              <span className="text-secondary-foreground text-sm">
                {t('accountCompanyProfile.branding.comprehensiveImageIdentity')}
              </span>
            </div>
            <div className="flex flex-col gap-5 max-w-96 w-full">
              <div className="flex flex-col gap-2.5">
                <div className="flex items-center space-x-2">
                  <Checkbox id={id} />
                  <Label htmlFor={id}>{t('accountCompanyProfile.branding.securityQuestionaries')}</Label>
                </div>
                <span className="text-secondary-foreground text-sm">
                  {t('accountCompanyProfile.branding.detailedRiskAssessment')}
                </span>
              </div>
              <div className="flex flex-col gap-2.5">
                <div className="flex items-center space-x-2">
                  <Checkbox id={id} defaultChecked />
                  <Label htmlFor={id}>{t('accountCompanyProfile.branding.emails')}</Label>
                </div>
                <span className="text-secondary-foreground text-sm">
                  {t('accountCompanyProfile.branding.electronicMessageCommunication')}
                </span>
              </div>
              <div className="flex flex-col gap-2.5">
                <div className="flex items-center space-x-2">
                  <Checkbox id={id} defaultChecked />
                  <Label htmlFor={id}>{t('accountCompanyProfile.branding.vendorReports')}</Label>
                </div>
                <span className="text-secondary-foreground text-sm">
                  {t('accountCompanyProfile.branding.supplierPerformance')}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <Button>{t('accountCompanyProfile.branding.saveChanges')}</Button>
          </div>
        </CardContent>
      </Card>
    </>

    ...
    <Fragment>
      ...
      <Card>
        <CardHeader className="mb-5" id="external_services_manage_api">
          <CardTitle>{title || t('accountSettingsSidebar.externalServicesManageApi.title')}</CardTitle>
          {showSwitch && (
            <div className="flex items-center gap-2">
              <Label htmlFor="auto-update" className="text-sm">
                {t('accountSettingsSidebar.externalServicesManageApi.pause')}
              </Label>
        ...
        <CardContent className="lg:py-7.5 grid gap-5 lg:gap-7.5">
          <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
            <Label className="flex w-full max-w-56 text-foreground font-normal">
              {t('accountSettingsSidebar.externalServicesManageApi.apiKey')}
            </Label>
            <InputWrapper>
              <Input
                type="text"
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <div className="flex items-center flex-wrap gap-2.5">
                  ...
                  >
                    {t('accountSettingsSidebar.externalServicesManageApi.userAccess')}
                  </Link>
                  <Badge size="sm" variant="secondary">
                    {t('accountSettingsSidebar.externalServicesManageApi.daysLeft')}
                  </Badge>
                </div>
                <div className="form-info text-foreground font-normal">
                  {t('accountSettingsSidebar.externalServicesManageApi.apiKeyDescription')}{' '}
                  <Button mode="link" asChild>
                    <Link href="https://keenthemes.com/">@keenthemes</Link>
                  </Button>
                  <br />
                  {t('accountSettingsSidebar.externalServicesManageApi.secureAccessDescription')}
                </div>
              </div>
            </div>
            <div className="flex items-center flex-wrap md:flex-nowrap gap-1.5">
              <Button variant="mono">{t('accountSettingsSidebar.externalServicesManageApi.renewPlan')}</Button>
              <Button variant="ghost">{t('accountSettingsSidebar.externalServicesManageApi.docs')}</Button>
            </div>
          </div>
          <p className="text-sm text-foreground">
            {t('accountSettingsSidebar.externalServicesManageApi.unlockPotential')}
          </p>
        </CardContent>
      </Card>
    </Fragment>

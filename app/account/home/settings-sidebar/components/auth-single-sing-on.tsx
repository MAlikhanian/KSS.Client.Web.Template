    ...
    <Fragment>
      ...
      <Card>
        <CardHeader id="auth_social_sign_in_sso">
          <CardTitle>{t('accountSettingsSidebar.authSingleSignOn.title')}</CardTitle>
        </CardHeader>
        <CardContent className="flex flex-col gap-7.5">
          <div className="grid gap-7">
            <div className="text-base font-semibold text-mono">
              {t('accountSettingsSidebar.authSingleSignOn.selectIntegrationType')}
            </div>
          ...
          <div className="grid gap-7">
            <div className="text-base font-semibold text-mono">
              {t('accountSettingsSidebar.authSingleSignOn.configureGoogleAuth')}
            </div>
            <div className="w-full">
              <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                <Label className="flex w-full max-w-56">{t('accountSettingsSidebar.authSingleSignOn.clientId')}</Label>
                <Input type="text" placeholder="02874374-367145773" />
              </div>
            </div>
            <div className="w-full">
              <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                <Label className="flex w-full max-w-56">{t('accountSettingsSidebar.authSingleSignOn.clientSecret')}</Label>
                <Input
                  type="text"
            ...
            <div className="flex justify-end">
              <Button>{t('accountSettingsSidebar.authSingleSignOn.saveChanges')}</Button>
            </div>
          </div>
          <div className="border-b border-border"></div>
          <div className="grid gap-7">
            <div className="text-base font-semibold text-mono">
              {t('accountSettingsSidebar.authSingleSignOn.noteCustomUrl')}
            </div>
            <div className="w-full">
              <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5">
                <Label className="flex w-full max-w-56">{t('accountSettingsSidebar.authSingleSignOn.customLoginUrl')}</Label>
                <div className="grow">
                  <div className="flex items-center">
                    ...
                    />
                    <Button className="rounded-l-none border-l-0">{t('accountSettingsSidebar.authSingleSignOn.copy')}</Button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="form-info pb-5 text-foreground font-normal">
            {t('accountSettingsSidebar.authSingleSignOn.description')}
          </div>
        </CardContent>
      </Card>
    </Fragment>

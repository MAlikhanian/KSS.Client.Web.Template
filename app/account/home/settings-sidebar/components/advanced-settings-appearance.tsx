  ...
  const items: IAdvancedSettingsAppearanceItems = [
    {
      image: '28.jpg',
      logo: 'azure.svg',
      label: t('accountSettingsSidebar.advancedSettingsAppearance.dark'),
      checked: true,
    },
    {
      image: '32.jpg',
      logo: 'google.svg',
      label: t('accountSettingsSidebar.advancedSettingsAppearance.light'),
      checked: false,
    },
    {
      image: '30.jpg',
      logo: 'openid.svg',
      label: t('accountSettingsSidebar.advancedSettingsAppearance.system'),
      checked: false,
    },
  ];
  ...
  return (
    <Card>
      <CardHeader id="advanced_settings_appearance">
        <CardTitle>{title || t('accountSettingsSidebar.advancedSettingsAppearance.title')}</CardTitle>
      </CardHeader>
      <CardContent className="lg:py-7.5">
        <div className="mb-5">
          <h3 className="text-base font-medium text-mono">{t('accountSettingsSidebar.advancedSettingsAppearance.themeMode')}</h3>
          <span className="text-sm text-secondary-foreground">
            {t('accountSettingsSidebar.advancedSettingsAppearance.themeModeDescription')}
          </span>
        </div>
        ...
        <div className="flex items-baseline flex-wrap lg:flex-nowrap gap-2.5 mb-8">
          <Label className="flex w-full max-w-48 text-foreground font-normal">
            {t('accountSettingsSidebar.advancedSettingsAppearance.transparentSidebar')}
          </Label>
          <div className="flex items-center gap-7.5 grow">
            <Label htmlFor="auto-update" className="text-sm">
              {t('accountSettingsSidebar.advancedSettingsAppearance.active')}
            </Label>
            <Switch defaultChecked size="sm" />
            <span className="form-info text-foreground font-normal">
              {t('accountSettingsSidebar.advancedSettingsAppearance.transparentSidebarDescription')}
            </span>
          </div>
        </div>
        <div className="flex justify-end">
          <Button>{t('accountSettingsSidebar.advancedSettingsAppearance.saveChanges')}</Button>
        </div>
      </CardContent>
    </Card>
  );

...
const CommunityBadges = () => {
  ...
  const items: ICommunityBadgesItems = [
    {
      title: t('accountUserProfile.communityBadges.expertContributor'),
    ...
    {
      title: t('accountUserProfile.communityBadges.innovationTrailblazer'),
    ...
    {
      title: t('accountUserProfile.communityBadges.impactRecognition'),
    ...
    {
      title: t('accountUserProfile.communityBadges.performanceHonor'),
  ...
  return (
    <Card>
      <CardHeader className="gap-2">
        <CardTitle>{t('accountUserProfile.communityBadges.title')}</CardTitle>
        <DropdownMenu2
          trigger={

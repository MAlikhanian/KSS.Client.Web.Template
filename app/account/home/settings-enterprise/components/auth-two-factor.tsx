  ...
  const items: IAuthTwoFactorItems = [
    {
      ...
      title: t('accountSettingsEnterprise.authTwoFactor.items.textMessage.title'),
      description: t('accountSettingsEnterprise.authTwoFactor.items.textMessage.description'),
      checkbox: true,
    },
    {
      icon: ShieldCheck,
      title: t('accountSettingsEnterprise.authTwoFactor.items.authenticatorApp.title'),
      description: t('accountSettingsEnterprise.authTwoFactor.items.authenticatorApp.description'),
      checkbox: false,
    },
  ];
  ...
  return (
    <Card>
      <CardHeader className="gap-2" id="settings_auth_two_factor">
        <CardTitle>{t('accountSettingsEnterprise.authTwoFactor.title')}</CardTitle>
        <DropdownMenu2
          trigger={

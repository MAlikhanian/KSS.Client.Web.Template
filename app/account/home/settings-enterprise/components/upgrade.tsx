          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center flex-wrap gap-2.5">
                ...
                >
                  {t('accountSettingsEnterprise.upgrade.title')}
                </Link>
                <Badge variant="secondary">{t('accountSettingsEnterprise.upgrade.daysLeft')}</Badge>
              </div>
              <div className="text-sm text-foreground">
                {t('accountSettingsEnterprise.upgrade.description')}
              </div>
            </div>
          </div>
          <div className="flex items-center gap-1.5">
            <Button variant="mono">{t('accountSettingsEnterprise.upgrade.start')}</Button>
            <Button variant="ghost">{t('accountSettingsEnterprise.upgrade.skip')}</Button>
          </div>
        </div>
      </Card>
    </>

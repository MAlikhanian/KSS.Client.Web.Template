...
const ApiIntegrations = () => {
  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => {
      const ColumnInputFilter = <TData, TValue>({
        ...
        return (
          <Input
            placeholder={t('accountApiKeys.apiIntegrations.filterPlaceholder')}
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader
            title={t('accountApiKeys.apiIntegrations.columns.integration')}
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountApiKeys.apiIntegrations.columns.apiKey')} column={column} />
        ),
        cell: (info) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountApiKeys.apiIntegrations.columns.dailyCalls')} column={column} />
        ),
        cell: (info) => info.getValue(),
        enableSorting: true,
        size: 130,
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountApiKeys.apiIntegrations.columns.status')} column={column} />
        ),
        cell: (info) => info.getValue(),
        enableSorting: true,
        size: 100,
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <div className="flex items-center space-x-2">
            <Label htmlFor="auto-update" className="text-sm">
              {t('accountApiKeys.apiIntegrations.toolbar.pauseAll')}
            </Label>
            <Switch size="sm" />
          </div>
          <Button>{t('accountApiKeys.apiIntegrations.toolbar.addNew')}</Button>
          <DataGridColumnVisibility
            table={table}
            trigger={
              <Button variant="outline">
                <Settings2 />
                {t('accountApiKeys.apiIntegrations.toolbar.columns')}
              </Button>
            }
          />
        </div>
  ...
  return (
    ...
    >
      <Card>
        <CardHeader>
          <CardTitle>{t('accountApiKeys.apiIntegrations.title')}</CardTitle>
          <Toolbar />
        </CardHeader>
        <CardTable>
          <ScrollArea>

...
function ActionsCell({ row }: { row: Row<IData> }) {
  ...
  const handleCopyId = () => {
    ...
    const message = t('accountSecurityCurrentSessions.sessionIdCopied', { id: row.original.id });
    toast.custom(
      (t) => (
        <Alert
          variant="mono"
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent side="bottom" align="end">
        ...
        >
          {t('accountSecurityCurrentSessions.actions.action')}
        </DropdownMenuItem>
        <DropdownMenuItem onClick={handleCopyId}>{t('accountSecurityCurrentSessions.actions.copyId')}</DropdownMenuItem>
        <DropdownMenuSeparator />
        <DropdownMenuItem variant="destructive" onClick={() => {}}>
          {t('accountSecurityCurrentSessions.actions.delete')}
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
  );
  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityCurrentSessions.columns.person')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityCurrentSessions.columns.browser')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityCurrentSessions.columns.ipAddress')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityCurrentSessions.columns.location')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      <CardToolbar>
        <div className="flex flex-wrap items-center gap-2.5">
          <Label htmlFor="auto-update" className="text-sm">
            {t('accountSecurityCurrentSessions.toolbar.onlyActiveUsers')}
          </Label>
        ...
        <DataGridColumnVisibility
          ...
          trigger={
            <Button variant="outline">
              <Settings2 />
              {t('accountSecurityCurrentSessions.toolbar.columns')}
            </Button>
          }
        />
      </CardToolbar>
          ...
          <CardHeading>
            <div className="flex items-center gap-2.5">
              <div className="relative">
                ...
                <Input
                  placeholder={t('accountSecurityCurrentSessions.searchPlaceholder')}
                  value={searchQuery}
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline">
                    <Filter />
                    {t('accountSecurityCurrentSessions.browser')}
                ...
                <PopoverContent className="w-40 p-3" align="start">
                  <div className="space-y-3">
                    <div className="text-xs font-medium text-muted-foreground">
                      {t('accountSecurityCurrentSessions.filters')}
                    </div>
                    <div className="space-y-3">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="outline">
                    <Filter />
                    {t('accountSecurityCurrentSessions.location')}

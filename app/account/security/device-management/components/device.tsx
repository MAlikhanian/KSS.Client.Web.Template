  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => {
      const ColumnInputFilter = <TData, TValue>({
        ...
        return (
          <Input
            placeholder={t('accountSecurityDeviceManagement.filter')}
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader
            title={t('accountSecurityDeviceManagement.columns.device')}
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityDeviceManagement.columns.ipAddress')} column={column} />
        ),
        cell: (info) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityDeviceManagement.columns.location')} column={column} />
        ),
        cell: (info) => (
          <span className="text-sm text-foreground font-normal">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-2">
                  ...
                  <DataGridColumnHeader
                    title={t('accountSecurityDeviceManagement.columns.added')}
                    visibility={true}
                    column={column}
                  />
                </div>
              ...
              <TooltipContent>
                <p>{t('accountSecurityDeviceManagement.columns.addedTooltip')}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        ),
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityDeviceManagement.columns.lastSession')} column={column} />
        ),
        cell: (info) => (
          <span className="text-sm text-foreground font-normal">
    ...
    return (
      <CardToolbar>
        <div className="flex flex-wrap items-center gap-2.5">
          <Button>{t('accountSecurityDeviceManagement.toolbar.addDevice')}</Button>
        </div>
        <DataGridColumnVisibility
          ...
          trigger={
            <Button variant="outline">
              <Settings2 />
              {t('accountSecurityDeviceManagement.toolbar.columns')}
            </Button>
          }
        />
      </CardToolbar>
          ...
          <div className="flex items-center gap-2.5">
            <div className="relative">
              <Search className="size-4 text-muted-foreground absolute start-3 top-1/2 -translate-y-1/2" />
                <Input
                  placeholder={t('accountSecurityDeviceManagement.searchPlaceholder')}
                  value={searchQuery}

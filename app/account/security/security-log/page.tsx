            ...
            <ToolbarHeading>
              ...
              <div className="flex flex-wrap items-center gap-2 font-medium">
                <span className="text-sm text-secondary-foreground">
                  {t('accountSecurityLog.toolbar.authorizedDevices')}
                </span>
                <span className="size-0.75 bg-mono/50 rounded-full"></span>
                <Button mode="link" underlined="dashed" asChild>
                  <Link href="#">{t('accountSecurityLog.toolbar.unlinkAllDevices')}</Link>
                </Button>
              </div>
            </ToolbarHeading>
            <ToolbarActions>
              <Button variant="outline">
                <Link href="#">{t('accountSecurityLog.toolbar.securityOverview')}</Link>
              </Button>
            </ToolbarActions>
          </Toolbar>
        </Container>

  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityLog.columns.timestamp')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityLog.columns.eventType')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityLog.columns.actionTaken')} column={column} />
        ),
        cell: ({ row }) => (
          <span className="text-secondary-foreground font-normal">
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityLog.columns.sourceIp')} column={column} />
        ),
        cell: ({ row }) => (
          <span className="text-secondary-foreground font-normal">
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityLog.columns.destinationIp')} column={column} />
        ),
        cell: ({ row }) => (
          <span className="text-secondary-foreground font-normal">
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('accountSecurityLog.columns.severity')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      <CardToolbar>
        <div className="flex flex-wrap items-center gap-2.5">
          <Label htmlFor="auto-update" className="text-sm">
            {t('accountSecurityLog.toolbar.pushAlerts')}
          </Label>
        ...
        <DataGridColumnVisibility
          ...
          trigger={
            <Button variant="outline">
              <Settings2 />
              {t('accountSecurityLog.toolbar.columns')}
            </Button>
          }
        />
      </CardToolbar>
          ...
          <CardHeading>
            <div className="flex items-center gap-2.5">
              <div className="relative">
                ...
                <Input
                  placeholder={t('accountSecurityLog.searchPlaceholder')}
                  value={searchQuery}

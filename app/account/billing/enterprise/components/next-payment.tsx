...
const NextPayment = () => {
  ...
  return (
    <Card className="grow">
      <CardHeader>
        <CardTitle>{t('accountBillingEnterprise.nextPayment.title')}</CardTitle>
      </CardHeader>
      <CardContent className="lg:7.5">
        <div className="flex flex-col gap-5">
          <div className="flex items-center justify-between flex-wrap border border-border rounded-xl gap-2 px-4 py-4 bg-secondary-clarity">
            <div className="flex items-center gap-3.5">
              ...
              <div className="flex flex-col">
                ...
                >
                  {t('accountBillingEnterprise.nextPayment.date')}
                </Link>
                <p className="text-sm text-secondary-foreground">{t('accountBillingEnterprise.nextPayment.dueDate')}</p>
              </div>
            </div>
            <Button
              variant="outline"
          ...
          <div className="place-self-end lg:pb-2.5">
            <Button>{t('accountBillingEnterprise.nextPayment.managePayment')}</Button>
          </div>
        </div>
      </CardContent>
    </Card>

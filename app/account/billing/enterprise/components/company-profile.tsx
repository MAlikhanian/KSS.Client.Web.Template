...
const CompanyProfile = () => {
  ...
  const statistics: ICompanyProfileItems = [
    {
      total: t('accountBillingEnterprise.companyProfile.statusValue'),
      description: t('accountBillingEnterprise.companyProfile.status'),
    },
    {
      total: '10,000',
      description: t('accountBillingEnterprise.companyProfile.queryRuns'),
    },
    {
      total: t('accountBillingEnterprise.companyProfile.unlimited'),
      description: t('accountBillingEnterprise.companyProfile.apiCalls'),
    },
    {
      total: '$99.00',
      description: t('accountBillingEnterprise.companyProfile.price'),
    },
    {
      total: '17 Aug, 2024',
      description: t('accountBillingEnterprise.companyProfile.nextBillDate'),
    },
  ];
              ...
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-2.5">
                  <h2 className="text-2xl font-semibold text-mono">
                    {t('accountBillingEnterprise.companyProfile.planName')}
                  </h2>
                  <Badge size="md" variant="success" appearance="light">
                    {t('accountBillingEnterprise.companyProfile.monthlyPlan')}
                  </Badge>
                </div>
                <p className="text-sm text-secondary-foreground">
                  {t('accountBillingEnterprise.companyProfile.description')}
                </p>
              </div>
              <div className="flex items-center gap-2.5">
                <Button variant="outline">
                  <Link href="#">{t('accountBillingEnterprise.companyProfile.cancelPlan')}</Link>
                </Button>
                <Button>
                  <Link href="#">{t('accountBillingEnterprise.companyProfile.upgradePlan')}</Link>
                </Button>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-6 lg:gap-12">
              <div className="flex flex-col gap-3.5 grow">
                <div className="text-sm text-secondary-foreground">
                  {t('accountBillingEnterprise.companyProfile.queryRunsUsage', { used: 2239, total: 10000 })}
                </div>
              ...
              <div className="flex flex-col gap-2.5 lg:min-w-24 shrink-0 -mt-3 max-w-auto">
                <div className="text-sm font-medium text-secondary-foreground">
                  {t('accountBillingEnterprise.companyProfile.seats', { used: 29, total: 120 })}
                </div>

...
const LatestPayment = () => {
  ...
  const tables: ILatestPaymentItems = [
    { status: t('accountBillingEnterprise.latestPayment.typeOfPlan'), info: 'Cloud One Enterprise' },
    { status: t('accountBillingEnterprise.latestPayment.paymentDate'), info: '6 Aug, 2024' },
    { status: t('accountBillingEnterprise.latestPayment.cardUsed'), logo: true, info: 'Ending 3604' },
    { status: t('accountBillingEnterprise.latestPayment.totalPayment'), info: '$24.00' },
  ];
  ...
  return (
    <Card className="grow">
      <CardHeader>
        <CardTitle>{t('accountBillingEnterprise.latestPayment.title')}</CardTitle>
        <Button variant="outline">
          <Download size={20} />
          {t('accountBillingEnterprise.latestPayment.downloadPDF')}
        </Button>
      </CardHeader>

...
const Plan = () => {
  ...
  const statistics: IPlanItems = [
    {
      total: '$769.00',
      description: t('accountBillingBasic.plan.annualTotal'),
    },
    {
      total: '$69.00',
      description: t('accountBillingBasic.plan.nextBillAmount'),
    },
    {
      total: '23 Aug, 24',
      description: t('accountBillingBasic.plan.nextBillingDate'),
    },
  ];
        ...
        <div className="flex flex-col items-stretch gap-5 lg:gap-7.5">
          <div className="flex flex-wrap items-center gap-5 justify-between">
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-2.5">
                <h2 className="text-2xl font-semibold text-mono">{t('accountBillingBasic.plan.basicPlan')}</h2>
                <Badge size="md" variant="success" appearance="light">
                  {t('accountBillingBasic.plan.monthly')}
                </Badge>
              </div>
              <p className="text-sm text-secondary-foreground">
                {t('accountBillingBasic.plan.description')}
              </p>
            </div>
            <div className="flex gap-2.5">
              <Button variant="outline">
                <Link href="#">{t('accountBillingBasic.plan.cancelPlan')}</Link>
              </Button>
              <Button>
                <Link href="#">{t('accountBillingBasic.plan.upgradePlan')}</Link>
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3.5">
            <span className="text-sm text-secondary-foreground">
              {t('accountBillingBasic.plan.usage', { current: 32, total: 40 })}
            </span>

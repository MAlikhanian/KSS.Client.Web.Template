...
// Leaflet lives in CompanyMap. Import ONLY via next/dynamic so leaflet
// never appears in this file's static dep graph — keeps it out of the SSR bundle.
const CompanyMap = dynamic(() => import('./company-map'), { ssr: false });

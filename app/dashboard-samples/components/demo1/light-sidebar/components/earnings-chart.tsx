...
const EarningsChart = () => {
  ...
  const categories: string[] = [
    t('dashboard.earningsChart.january'),
    t('dashboard.earningsChart.february'),
    t('dashboard.earningsChart.march'),
    t('dashboard.earningsChart.april'),
    t('dashboard.earningsChart.may'),
    t('dashboard.earningsChart.june'),
    t('dashboard.earningsChart.july'),
    t('dashboard.earningsChart.august'),
    t('dashboard.earningsChart.september'),
    t('dashboard.earningsChart.october'),
    t('dashboard.earningsChart.november'),
    t('dashboard.earningsChart.december'),
  ];
  ...
  const options: ApexOptions = {
    series: [
      {
        name: t('dashboard.earningsChart.earnings'),
        data: chartData ?? [],
      },
    ],
    chart: {

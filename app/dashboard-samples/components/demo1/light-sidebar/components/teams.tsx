  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('dashboard.teams.team')} column={column} />
        ),
        cell: ({ row }) => (
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('dashboard.teams.rating')} column={column} />
        ),
        cell: ({ row }) => (
          <Rating
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('dashboard.teams.lastModified')} column={column} />
        ),
      ...
      },
      {
        ...
        header: ({ column }) => (
          <DataGridColumnHeader title={t('dashboard.teams.members')} column={column} />
        ),
        cell: ({ row }) => (
    ...
    >
      <Card>
        <CardHeader className="py-3.5">
          <CardTitle>{t('dashboard.teams.title')}</CardTitle>
          <CardToolbar className="relative">
            <Search className="size-4 text-muted-foreground absolute start-3 top-1/2 -translate-y-1/2" />
            <Input
              placeholder={t('dashboard.teams.searchTeams')}
              value={searchQuery}

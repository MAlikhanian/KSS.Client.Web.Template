...
const ChannelStats = () => {
  ...
  const items: IChannelStatsItems = [
    { logo: 'linkedin-2.svg', info: '9.3k', desc: t('dashboard.channelStats.amazingMates'), path: '' },
    { logo: 'youtube-2.svg', info: '24k', desc: t('dashboard.channelStats.lessonsViews'), path: '' },
    {
      logo: 'instagram-03.svg',
      info: '608',
      desc: t('dashboard.channelStats.newSubscribers'),
      path: '',
    },
    {
      logo: 'tiktok.svg',
      ...
      info: '2.5k',
      desc: t('dashboard.channelStats.streamAudience'),
      path: '',
    },
  ];

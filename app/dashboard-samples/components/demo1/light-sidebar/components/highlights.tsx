...
const Highlights = ({ limit }: IHighlightsProps) => {
  ...
  const rows: IHighlightsRows = [
    {
      icon: RiStore2Line,
      text: t('dashboard.highlights.onlineStore'),
      total: 172,
      stats: 3.9,
      increase: true,
    },
    {
      ...
      text: t('dashboard.highlights.facebook'),
      total: 85,
      stats: 0.7,
      increase: false,
    },
    {
      ...
      text: t('dashboard.highlights.instagram'),
      total: 36,
      stats: 8.2,
      increase: true,
    },
    {
      icon: RiGoogleLine,
      text: t('dashboard.highlights.google'),
      total: 26,
      stats: 8.2,
      increase: true,
    },
    { icon: RiBankLine, text: t('dashboard.highlights.retail'), total: 7, stats: 0.7, increase: false },
  ];
      ...
      <CardContent className="flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
        <div className="flex flex-col gap-0.5">
          <span className="text-sm font-normal text-secondary-foreground">
            {t('dashboard.highlights.allTimeSales')}
          </span>

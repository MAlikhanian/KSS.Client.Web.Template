...
const MENU_TRANSLATION_KEYS: Record<string, string> = {
  ...
  'SPM Investor Portal': 'menu.spmPortal',
  'Portal Overview': 'menu.spmPortalOverview',
  'Portal Funds': 'menu.spmPortalFunds',
  'Portal New Request': 'menu.spmPortalNewRequest',
  'Portal My Requests': 'menu.spmPortalMyRequests',
